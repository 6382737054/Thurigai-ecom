...
const Card = ({ children, className }) => (
  <motion.div
    className={`bg-ivory rounded-lg shadow-[0px_4px_20px_rgba(128,96,0,0.4)] p-8 ${className}`}
...
const Badge = ({ children }) => (
  <span className="inline-block bg-terracotta-100 text-terracotta-800 rounded-full px-4 py-1 text-sm font-medium">
    {children}
  </span>
);
...
const AboutUsSection = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-beige-500 to-ivory py-20 px-4 pt-44 font-serif">
      <motion.div 
        ref={ref}
        animate={controls}
        initial="hidden"
      ...
      >
        <motion.h1 
          className="text-5xl font-bold text-center mb-12 text-olive-800 leading-tight"
          variants={fadeInUp}
        >
          About Our <span className="text-terracotta">Inspired Art</span>
        </motion.h1>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20">
          <motion.div variants={fadeInUp}>
            <Card className="bg-taupe-50 border border-taupe-200">
              <h2 className="text-2xl font-bold mb-6 text-olive-700 flex items-center">
                <svg className="w-6 h-6 mr-3 text-terracotta" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
                </svg>
                Our Story
              </h2>
              <p className="mb-4 text-olive-700 leading-relaxed">
          ...
          <motion.div variants={fadeInUp}>
            <Card className="h-full bg-taupe-50 border border-taupe-200">
              <h2 className="text-2xl font-bold mb-6 text-olive-700 flex items-center">
                <svg className="w-6 h-6 mr-3 text-terracotta" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <motion.div variants={fadeInUp} className="mb-20">
          <h2 className="text-3xl font-bold mb-12 text-center text-olive-800">Our Core Values</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <Card key={index} className="text-center bg-ivory border border-taupe-100">
                <svg className="w-12 h-12 mx-auto mb-6 text-sienna" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={value.icon} />
                </svg>
                <h3 className="text-xl font-bold mb-3 text-olive-700">{value.title}</h3>
                <p className="text-olive-600">Committed to upholding the highest standards in everything we do.</p>
              </Card>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div variants={fadeInUp} className="mb-20">
          <h2 className="text-3xl font-bold mb-12 text-center text-olive-800">Our Achievements</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {[
              ...
              <Card key={index} className="bg-taupe-50 border border-taupe-200">
                <div className="text-4xl font-bold mb-4 text-olive-700">
        ...
        <motion.div variants={fadeInUp} className="mb-20">
          <h2 className="text-3xl font-bold mb-12 text-center text-olive-800">Meet Our Team</h2>
            ...
            {[
              ...
              <Card key={index} className="text-center bg-ivory border border-taupe-100">
                <img
                  src={member.image}
                  alt={member.name}
                  className="w-24 h-24 rounded-full mx-auto mb-6 object-cover border-2 border-taupe-200"
                />
                <h3 className="text-xl font-bold mb-2 text-olive-700">{member.name}</h3>
                <p className="text-olive-600 font-medium mb-3">{member.role}</p>
                <p className="text-olive-600">{member.bio}</p>
              </Card>
            ))}
          </div>
        </motion.div>
        ...
        <motion.div variants={fadeInUp}>
          <h2 className="text-3xl font-bold mb-12 text-center text-olive-800">Our Commitment to You</h2>
          <Card className="text-center bg-taupe-50 border border-taupe-200">
