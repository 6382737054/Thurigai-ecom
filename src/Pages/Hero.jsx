...
const Hero = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-[#f6e9d7] to-[#efeeec] min-h-screen py-20 px-2 sm:px-4 lg:px-6 pt-44 font-['Poppins',sans-serif]">
      <div className="max-w-7xl mx-auto">
        <AnimatedSection>
          <motion.div
            className="text-center mb-12"
          >
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#FF6B6B] mb-4 font-['Playfair_Display',serif]">
              Diwali Home Fest
            </h1>
            <p className="text-xl text-[#4A4A4A] max-w-2xl mx-auto font-['Poppins',sans-serif]">
        ...
        <AnimatedSection>
          <div className="flex flex-col md:flex-row items-center">
            ...
            >
              <h2 className="text-3xl font-bold text-[#4ECDC4] mb-6 flex items-center font-['Playfair_Display',serif]">
              ...
              <div className="mt-8 flex justify-center">
                <Link to="/products">
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="bg-[#FF6B6B] text-white py-3 px-6 rounded-full font-semibold hover:bg-[#FF8787] transition duration-300 flex items-center font-['Poppins',sans-serif] ml-1"
                  >
              ...
              {marqueeItems.map((item, index) => (
                <div key={index} className="mx-8 flex items-center">
                  {item.type === 'image' ? (
                    ...
                    <h3 className="text-2xl font-bold text-[#4A4A4A] font-['Playfair_Display',serif]">{item.content}</h3>
                  )}
                </div>
              ))}
            </Marquee>
        ...
        <AnimatedSection>
          <motion.div className="mt-24">
            <h2 className="text-3xl font-bold text-[#FF6B6B] mb-8 text-center font-['Playfair_Display',serif]">Why Choose Us</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 w-full md:w-[90%] rounded-lg shadow-md shadow-[#FFE66D] flex items-center">
                <Truck className="mr-4 text-[#4ECDC4]" size={48} />
                <div>
                  <h3 className="text-xl font-semibold mb-2 font-['Playfair_Display',serif]">Fast and Reliable Shipping</h3>

                  <p className="text-[#4A4A4A] font-['Poppins',sans-serif]">Get your festive essentials delivered right to your doorstep, in time for your celebrations.</p>
                </div>
              </div>
              <div className="bg-white p-6 w-full md:w-[90%] rounded-lg shadow-md shadow-[#FFE66D] flex items-center">
                <Star className="mr-4 text-[#4ECDC4]" size={48} />
                <div>
                  <h3 className="text-xl font-semibold mb-2 font-['Playfair_Display',serif]">Handpicked Products</h3>
                  <p className="text-[#4A4A4A] font-['Poppins',sans-serif]">We curate the finest selection of products to ensure the highest quality and craftsmanship.</p>
                </div>
              </div>
              <div className="bg-white p-6 w-full md:w-[90%] rounded-lg shadow-md shadow-[#FFE66D] flex items-center">
                <Smile className="mr-4 text-[#4ECDC4]" size={48} />
                <div>
                  <h3 className="text-xl font-semibold mb-2 font-['Playfair_Display',serif]">Exceptional Customer Service</h3>
                  <p className="text-[#4A4A4A] font-['Poppins',sans-serif]">Our dedicated team is always ready to assist you and ensure your utmost satisfaction.</p>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <AnimatedSection>
          <motion.div className="mt-24">
            <h2 className="text-3xl font-bold text-[#FF6B6B] mb-8 text-center font-['Playfair_Display',serif]">Featured Products Gallery</h2>
            <Swiper
              onSwiper={setSwiper}
              slidesPerView={4}
              spaceBetween={10}
        ...
        <AnimatedSection>
          <motion.div className="mt-24">
            <h2 className="text-3xl font-bold text-[#FF6B6B] mb-12 text-center font-['Playfair_Display',serif]">Discover Our Diwali Specials</h2>
            {alternatingContent.map((content, index) => (
              ...
              >
                ...
                >
                  <motion.h3 
                    className="text-2xl font-bold text-[#4ECDC4] mb-4 font-['Playfair_Display',serif]"
                  ...
                  <motion.p 
                    className="text-[#4A4A4A] text-lg leading-relaxed mb-6 font-['Poppins',sans-serif]"
                    whileHover={{ scale: 1.05 }}
                    transition={{ duration: 0.3 }}
                  >
                    {content.description}
        ...
        <AnimatedSection>
          <motion.div className="mt-24">
            <h2 className="text-3xl font-bold text-[#FF6B6B] mb-12 text-center font-['Playfair_Display',serif]">What Our Customers Say</h2>
            <div className="relative">
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  />
                  <p className="text-[#4A4A4A] text-lg italic mb-4 text-center font-['Poppins',sans-serif]">"{testimonials[currentTestimonial].text}"</p>
                  <div className="mt-auto">
                    <p className="font-semibold text-[#4ECDC4] text-center font-['Playfair_Display',serif]">{testimonials[currentTestimonial].name}</p>
                    <p className="text-[#4A4A4A] text-sm text-center font-['Poppins',sans-serif]">{testimonials[currentTestimonial].location}</p>
                  </div>
                </motion.div>
              </AnimatePresence>
                ...
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full mx-1 focus:outline-none transition-colors duration-300 ${
                      currentTestimonial === index ? 'bg-[#FF6B6B]' : 'bg-[#FFE66D]'
                    }`}
        ...
        <AnimatedSection>
  <motion.div className="mt-24">
    <h2 className="text-3xl font-bold text-[#FF6B6B] mb-12 text-center font-['Playfair_Display',serif]">Key Features</h2>
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="flex flex-col items-center text-center">
        <div className="bg-[#FFE66D] rounded-full p-4 mb-4">
          <Package className="h-10 w-10 text-[#FF6B6B]" />
        </div>
        <h3 className="text-xl font-semibold text-[#0d3a37] mb-2 font-['Playfair_Display',serif]">Free delivery across India</h3>
        <p className="text-[#4A4A4A] font-['Poppins',sans-serif]">Enjoy free delivery on orders over ₹999 within India and $59 internationally. We guarantee fast delivery.</p>
      </div>
      <div className="flex flex-col items-center text-center">
        <div className="bg-[#FFE66D] rounded-full p-4 mb-4">
          <RefreshCw className="h-10 w-10 text-[#FF6B6B]" />
        </div>
        <h3 className="text-xl font-semibold text-[#0d3a37] mb-2 font-['Playfair_Display',serif]">Easy replacement</h3>
        <p className="text-[#4A4A4A] font-['Poppins',sans-serif]">If you receive a damaged product, we'll gladly take it back! Enjoy a hassle-free shopping experience.</p>
      </div>
      <div className="flex flex-col items-center text-center">
        <div className="bg-[#FFE66D] rounded-full p-4 mb-4">
          <ShieldCheck className="h-10 w-10 text-[#FF6B6B]" />
        </div>
        <h3 className="text-xl font-semibold text-[#0d3a37] mb-2 font-['Playfair_Display',serif]">100% Authentic</h3>
        <p className="text-[#4A4A4A] font-['Poppins',sans-serif]">Shop with peace of mind knowing that all our products are 100% authentic.</p>
      </div>
      <div className="flex flex-col items-center text-center">
        <div className="bg-[#FFE66D] rounded-full p-4 mb-4">
          <CreditCard className="h-10 w-10 text-[#FF6B6B]" />
        </div>
        <h3 className="text-xl font-semibold text-[#0d3a37] mb-2 font-['Playfair_Display',serif]">Secure payments</h3>
        <p className="text-[#4A4A4A] font-['Poppins',sans-serif]">Our website offers a 100% secure payment gateway, ensuring a completely safe shopping experience for you.</p>
      </div>
    </div>
  </motion.div>
</AnimatedSection>
